<template>
  <section class="container">
    ...
    <div class="alert alert-light">
      <p>This report aggregates publications by research area and year, in order to show trends in research by
         research area over time. You can filter by school, department and year of publication.</p>
    </div>
    <ReportTable v-bind:data-source="reportURL"></ReportTable>
    <div class="alert alert-light">
      <p>Research area data for these reports are pulled from publications in the Web of Science, a Clarivate product. Note
         that Clarivate categorizes publications into research areas at the level of a journal (not individual
